...
\begin{figure}[H]
  \centering
\includegraphics[width=0.65\textwidth,keepaspectratio]{\string"../quantlets/Exploratory_Data_Analysis/PriceHist\string".pdf}
  \caption{Histogram of SalePrice}\label{fig:pricehist}
\end{figure}

\begin{figure}[H]
  \centering
\includegraphics[width=0.65\textwidth,keepaspectratio]{\string"../quantlets/Exploratory_Data_Analysis/LogPriceHist\string".pdf}
  \caption{Histogram of log SalePrice}\label{fig:logpricehist}
\end{figure}

\begin{figure}[H]
  \centering
\includegraphics[width=0.65\textwidth,keepaspectratio]{\string"../quantlets/Exploratory_Data_Analysis/StdPriceQQ\string".pdf}
...
\begin{figure}[H]
  \centering
\includegraphics[width=0.8\textwidth,keepaspectratio]{\string"../quantlets/Exploratory_Data_Analysis_Dependence/Corrplot\string".png}
  \caption{Visualization of correlation structure for variables with higher dependencies}\label{fig:corrgram}
\end{figure}

\begin{figure}[H]
  \centering
\includegraphics[height=10cm,keepaspectratio]{\string"../quantlets/Exploratory_Data_Analysis_Dependence/Barplot_ordered\string".png}
  \caption{Barplot of correlations with \textit{SalePrice} (ordered from high to low)}\label{fig:barplot_ordered}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[height=10cm,keepaspectratio]{\string"../quantlets/Exploratory_Data_Analysis_Dependence/boxplot_7through12\string".png}
...
\begin{figure}[H]
\centering
	\includegraphics[height=10cm,keepaspectratio]{\string"../quantlets/Exploratory_Data_Analysis_Dependence/boxplot_37through43\string".png}
