...
\begin{figure}[H]
  \centering
\includegraphics[width=0.7\textwidth,keepaspectratio]{\string"../quantlets/Exploratory_Data_Analysis/PriceHist\string".pdf}
  \caption{Histogram of Sale Prices}\label{fig:pricehist}
\end{figure}

\begin{figure}[H]
  \centering
\includegraphics[width=0.7\textwidth,keepaspectratio]{\string"../quantlets/Exploratory_Data_Analysis/LogPriceHist\string".pdf}
  \caption{Histogram of Log Sale Prices}\label{fig:logpricehist}
\end{figure}

\begin{figure}[H]
  \centering
\includegraphics[width=0.7\textwidth,keepaspectratio]{\string"../quantlets/Exploratory_Data_Analysis/StdPriceQQ\string".pdf}
