...
\begin{figure}[H]
  \centering
\includegraphics[width=0.65\textwidth,keepaspectratio]{\string"../quantlets/Exploratory_Data_Analysis/PriceHist\string".png}
  \caption{Histogram of SalePrice}\label{fig:pricehist}
\end{figure}

\begin{figure}[H]
  \centering
\includegraphics[width=0.65\textwidth,keepaspectratio]{\string"../quantlets/Exploratory_Data_Analysis/LogPriceHist\string".png}
  \caption{Histogram of log SalePrice}\label{fig:logpricehist}
\end{figure}

\begin{figure}[H]
  \centering
\includegraphics[width=0.65\textwidth,keepaspectratio]{\string"../quantlets/Exploratory_Data_Analysis/StdPriceQQ\string".png}
