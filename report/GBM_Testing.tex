...
\begin{figure}
  \centering
\includegraphics[width=0.8\textwidth,keepaspectratio]{\string"../quantlets/SPL_Random_Forest/gbm_rmse\string".png}
  \caption{GBM Tuning Results - Root Mean Squared Error}\label{fig:gmb_rmse}
\end{figure}

\begin{figure}
  \centering
\includegraphics[width=0.8\textwidth,keepaspectratio]{\string"../quantlets/SPL_Random_Forest/gbm_rsq\string".png}
